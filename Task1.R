...
search_terms = c('football','food','astrophysics')

file.cr = read.csv(paste0("G:\\taba\\tutorial\\","football google search.csv"))
file.mi = read.csv(paste0("G:\\taba\\tutorial\\","food google search.csv"))
file.lin = read.csv(paste0("G:\\taba\\tutorial\\","astrophysics google search.csv"))
...
adj.mat = t(as.matrix(dtm)) %*% as.matrix(dtm)
